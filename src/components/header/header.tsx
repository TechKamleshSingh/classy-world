...
export default function header() {
  ...
  return (
    <div className=''>
      <div className=' bg-red-300 flex  2xl:bg-slate-500 lg:bg-green-300 xl:bg-neutral-500 md:bg-amber-300'>
        ...
        <div className="center flex-1 p-1  flex justify-around items-center text-cyan-200 ">
      ...
      <nav className='relative flex container p-2 bg-white '>
      

        <div className="left md:bg-white bg-gray-300 z-50 ul-left hidden  md:flex md:relative absolute left-0 top-0 w-full md:w-3/5">
          ...
          <ul className='md:bg-white  md:flex uppercase text-sm space-y-1 justify-center items-center gap-5 p-3 '>
